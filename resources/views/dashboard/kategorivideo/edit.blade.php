...
<div class="panel-heading">Edit Data {{$kategorivideo->kategori}}</div>
...
{!! Form::model($kategorivideo,['method'=>'PATCH','route'=>['admin.kategorivideo.update',$kategorivideo->id],'class'=>'form-horizontal','files'=>true])!!}
@include('dashboard/kategorivideo/form/form',['submit_text'=>'Edit Data'])
{!! Form::close()!!}
