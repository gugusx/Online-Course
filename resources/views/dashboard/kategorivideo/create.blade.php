...
<div class="panel-heading">Tambah Kategori Video</div>
...
{!! Form::model(new App\kategorivideo, ['class' =>'form-horizontal','files'=>'true','route'=>['admin.kategorivideo.store']])!!}

@include('dashboard/kategorivideo/form/formadd',['submit_text'=>'Tambah Data'])
