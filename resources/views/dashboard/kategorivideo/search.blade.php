...
{!! link_to_route('admin.kategorivideo.create','Tambah Kategori Video','',array('class'=>'btn btn-success'))!!}
...
<?php $no=1 ?>
			...
			<td data-label="Judul">{{$r->judul}}</td>
					 ...
					 <td data-label="Edit">			  <a href="{{asset('admin/kategorivideo/'.$r->id.'/edit')}}" class="btn btn-info btn-xs" style="color:#fff"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
