...
<div class="panel-heading">Tambah Email</div>
...
{!! Form::model(new App\email, ['class' =>'form-horizontal','files'=>'true','route'=>['admin.email.store']])!!}

@include('dashboard/email/form/form',['submit_text'=>'Tambah Data'])
