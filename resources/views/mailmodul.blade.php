                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td> <div class="container">
                                                                    <center><p>Pembelian kursus anda telah dikonfirmasi</p></center>
                                                                    <hr>
@php
	$cartx = DB::table('cart')->where('transaksi_id', $tran['kode'])
...
@endphp
            <table class="table table-striped">
        		...
        		<tr>
        			...
        			<td>:</td>
        			<td>Transfer via {{ $tran['metode'] }}</td>
        		</tr>
        		<tr>
        			<td>Status</td>
        			<td>:</td>
        		...
        		<tr>
        			<td colspan="3" align="center">
        				<a href="{{ route('result', ['id' => $tran['kode']]) }}" target="_blank"></a>
        			{{ route('result', ['id' => $tran['kode']]) }}</td>
        		</tr>
        	</table>


                                                                    <hr>
                                                                    <center><p> <br> Terimakasih sudah berlangganan </p></center>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        </tbody>
